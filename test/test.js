import { GetValue, GetFormat } from "../packages/init/value";

// describe("value.js 值测试", () => {
//   it("测试 a.b.c.d.e.f", () => {
//     for (let i = 0; i < 1; i++) {
//       expect(GetValue("a.b.c.d.e.f", { a: { b: { c: { d: { e: { f: 1 } } } } } })).toBe(1);
//     }
//   });
//   it("测试 a.b.c.[0].d.e.f", () => {
//     for (let i = 0; i < 1; i++) {
//       expect(GetValue("a.b.c.[0].d.e.f", { a: { b: { c: [{ d: { e: { f: 1 } } }, { d: { e: { f: 1 } } }, { d: { e: { f: 1 } } }] } } })).toBe(1);
//     }
//   });
//   it("测试 a.b.c.[d.e.f === 1].d.e.f", () => {
//     for (let i = 0; i < 1; i++) {
//       expect(GetValue("a.b.c.[d.e.f === 1].d.e.f", { a: { b: { c: [{ d: { e: { f: 1 } } }, { d: { e: { f: 2 } } }, { d: { e: { f: 3 } } }] } } })).toBe(1);
//     }
//   });
...
//     for (let i = 0; i < 1; i++) {
//       expect(GetValue("a.b.c.[d.e.f === 1].d.e.f", { a: { b: { c: [{ d: { e: { f: 1 } } }, { d: { e: { f: 2 } } }, { d: { e: { f: 3 } } }] } } }, "time")).toBe("1970-01-01");
//     }
//   });
// });
...
describe("value.js format数据格式化测试", () => {
  it("测试 a.b.c.d.e.f", () => {
    for (let i = 0; i < 1; i++) {
      expect(GetFormat(1, { ">=1": "你好" })).toBe("你好");
    }
  });
});
