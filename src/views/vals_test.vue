<template>
  ...
  <div>user.sex = {{sex}}</div>
  <div>user.birth = {{birth}}</div>
  <div>children[0].name = {{c1}}</div>
  <div>children.[0].name = {{c2}}</div>
  <div>children[id=="1"].name = {{c3}}</div>
</template>
...
let info = {
  ...
  children:[{id:"1",name:"小明",age:12,sub:{id:"3"}},{id:"2",name:"小红",age:7}]
}
